$(document).ready(function(){
	...
	$('.pr-list-sx').click(function(){
		$('.pro-sx-bg').fadeIn();
		$('.pro-sx-model').fadeIn();
	})

	$('.pro-sx-model-list').click(function(){
		$(this).next('.pro-sx-model-list-ul').slideToggle();
	...
	$('.cart-shop-allcheck').toggle(function(){
			$('.cart-shop-allcheck #cart-shopall').attr('checked','checked');
			$('.cart-shop-com-box').find('input[type="checkbox"]').attr('checked','checked');
		},function (){
			$('.cart-shop-allcheck #cart-shopall').removeAttr('checked');
			$('.cart-shop-com-box').find('input[type="checkbox"]').removeAttr('checked');
		}
	)
